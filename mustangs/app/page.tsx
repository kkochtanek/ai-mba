    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-navy-900 text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-5 py-20 sm:py-28 text-center">
          ...
          <p className="text-lg sm:text-xl text-navy-100/85 max-w-2xl mx-auto mb-8 font-medium">
            The Meramec 2nd Grade Mustangs — {team.roster} kids from{" "}
            {team.school} playing 8v8 soccer together at Shaw Park, {team.city}.
          </p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              href="/schedule"
              className="bg-silver-700 text-white font-bold uppercase tracking-wide text-sm px-7 py-3.5 shadow hover:bg-navy-600 transition-colors"
            >
              View Schedule
            </Link>
            <Link
        ...
        <div className="bg-white shadow-lg border border-navy-100 grid grid-cols-2 sm:grid-cols-4 divide-x divide-navy-100">
          {seasonMilestones.map((m) => (
            <div key={m.label} className="px-4 py-6 text-center">
              <p className="text-[0.65rem] uppercase tracking-widest text-silver-700 font-bold mb-1">
                {m.label}
              </p>
      ...
      <section className="max-w-5xl mx-auto px-5 py-16 grid gap-6 sm:grid-cols-5">
        <div className="sm:col-span-2 bg-navy-900 text-white p-7 flex flex-col">
          <p className="text-[0.65rem] font-bold uppercase tracking-widest text-silver-600 mb-2">
            Next Up
          </p>
          ...
          <Link
            href="/schedule"
            className="inline-block mt-5 text-sm font-bold uppercase tracking-wide text-silver-600 hover:text-white"
          >
            Full schedule →
          </Link>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-5 pb-20">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link href="/news" className="text-sm font-bold uppercase tracking-wide text-silver-700 hover:text-navy-600">
            See all →
          </Link>
        </div>
